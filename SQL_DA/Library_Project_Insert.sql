...
-- Tạo bảng nhà xuất bản: Tên, địa chỉ, số điện thoại - Đặt khóa chính là tên của nhà xuất bản
	CREATE TABLE tbl_publisher (
		publisher_PublisherName VARCHAR(100) PRIMARY KEY NOT NULL, -- Khóa chính
		publisher_PublisherAddress VARCHAR(200) NOT NULL,
		publisher_PublisherPhone VARCHAR(50) NOT NULL,
	);
-- Tạo bảng về sách: ID của sách, Tên cuốn sách, Tên nhà xuất bản
	CREATE TABLE tbl_book (
		book_BookID INT PRIMARY KEY NOT NULL IDENTITY (1,1), -- Khóa chính
		book_Title VARCHAR(100) NOT NULL,
		-- Tạo khóa ngoại và đặt tên nó bên trong bảng tới bảng publisher
...
-- Tạo bảng Chi nhánh trong hệ thống quản lý: ID chi nhánh, tên chi nhánh và Địa chỉ của chi nhánh đó
	CREATE TABLE tbl_library_branch (
		library_branch_BranchID INT PRIMARY KEY NOT NULL IDENTITY (1,1), -- Khóa chính
		library_branch_BranchName VARCHAR(100) NOT NULL,
		library_branch_BranchAddress VARCHAR(200) NOT NULL,
	);

	SELECT * FROM tbl_library_branch
-- Tạo bảng người mượn sách: Số thẻ mượn, Tên người mượn, Địa chỉ
...
-- Tạo bảng về sách đã cho mượn: ID mượn, ID cuốn sách, ID của chi nhánh, Num card mượn, Ngày mượn, Ngày trả
...
-- Cập nhật ngày trả: 08/29/2022
	UPDATE tbl_book_loans
	SET book_loans_DueDate = GETDATE();
-- Tạo bảng sách copy: ID, ID của sách nguyên bản, ID của chi nhánh, Số lượng sách Coppy
...
-- Tạo bảng tác giả: ID tác giả, ID cuốn sách của họ, Tên tác giả.
